% Run decoding analysis for target status - focusing on the RELEVANT
% target (VIEW during Viewpoint task, and ID during Identity task)
% Using all voxels per ROI.
...
typestr = 'classify_target_withinCond';
