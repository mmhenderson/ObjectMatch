...
% Use trials from both conditions, 50 voxels
...
%             thistaskinds = trialData(vv).tasklabelsTBT==cc;
            ...
            parfor ii=1:nShuffIter
                ...
                [acc,dprime,predLabs,distEuc,failedInds] = my_classifier_normEucDist_balance2(dat,randlabs,correctlabs,runlabs,nBalanceIter2,nVox2Use_now,pTable(:,unruns),resamp);
